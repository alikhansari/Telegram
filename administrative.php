<?php
									...
									if(substr($message_body,0,8)=="/addinfo")
									{
										...
										if($info_id)
											$reply_msg="اطلاعات با موفقیت اضافه شد.شماره: ".$info_id."
											برای افزودن عکس و داکیومنت از فرمت دستوری زیر می توانید استفاده کنید:
									...
									elseif(substr($message_body,0,12)=="/setinfotext")
									{
										...
										if($info_edit)
											$reply_msg="متن اطلاعات با موفقیت ویرایش شد";
											
										else $reply_msg="خطا در تنظیم متن اطلاعات";
									}
									elseif(substr($message_body,0,11)=="/setinfopic")
									{
										...
										if($info_edit)
											$reply_msg="تصویر اطلاعات با موفقیت ویرایش شد";
											
										else $reply_msg="خطا در تنظیم تصویر اطلاعات";
									}
									elseif(substr($message_body,0,11)=="/setinfodoc")
									{
										...
										if($info_edit)
											$reply_msg="داکیومنت اطلاعات با موفقیت ویرایش شد";
											
										else $reply_msg="خطا در تنظیم داکیومنت اطلاعات";
									}
									elseif(substr($message_body,0,11)=="/setinfokey")
									{
										...
										if($info_edit)
											$reply_msg="کلید اطلاعات با موفقیت ویرایش شد";
											
										else $reply_msg="خطا در تنظیم کلید اطلاعات";
									}
									elseif(substr($message_body,0,12)=="/setinfofeed")
									{
										...
										if($info_edit)
											$reply_msg="شناساگر خبرخوان اطلاعات با موفقیت ویرایش شد";
											
										else $reply_msg="خطا در تنظیم شناساگر خبرخوان اطلاعات";
									}
									if(substr($message_body,0,8)=="/addfeed")
									{
										...
										if($feed_id)
											$reply_msg="خبرخوان با موفقیت اضافه شد.شماره: ".$feed_id."
											برای انتصاب خبرخوان به یک دستور، از فرمت دستوری زیر می توانید استفاده کنید:
											/setinfofeed info_id#".$feed_id;
										else $reply_msg="خطا در افزودن خبرخوان";
									}
									elseif(substr($message_body,0,11)=="/setfeedurl")
									{
										...
										if($feed_edit)
											$reply_msg=" خبرخوان با موفقیت ویرایش شد";
											
										else $reply_msg="خطا در تنظیم  خبرخوان";
									}
									elseif(substr($message_body,0,13)=="/setfeedcount")
									{
										...
										if($feed_edit)
											$reply_msg="تعداد لینک های خبرخوان با موفقیت ویرایش شد";
									...
									elseif($message_body=="/showfeedall" || $message_body=="showfeedall")
									{
										...
										if($all_cmd)
										{
											...
											$reply_msg="خبرخوانی جهت نمایش یافت نشد";
									...
									elseif(substr($message_body,0,8)=="/delfeed")
									{
										...
										if($db_op->remove_feed($id))
											$reply_msg="خبرخوان با موفقیت حذف شد.";
										else $reply_msg="خطا در حذف خبرخوان";
									...
									elseif($message_body=="/showinfoall" || $message_body=="showinfoall")
									{
										...
										if($all_cmd)
										{
											...
											$reply_msg="اطلاعاتی جهت نمایش یافت نشد";
									...
									elseif(substr($message_body,0,8)=="/delinfo")
									{
										...
										if($db_op->delete_info($id))
											$reply_msg="اطلاعات با موفقیت حذف شد.";
										else $reply_msg="خطا در حذف اطلاعات";
									...
									elseif( $message_body=="/getgroupscount" || $message_body=="getgroupscount")
									{
										...
										$reply_msg="تعداد گروه هایی که هم اکنون ربات در آن ها عضو است ".$groups_all_cnt." عدد است. \n";
										$reply_msg.="جهت مشاهده لیست گروه ها دستور زیر را وارد کنید: \n /getgroups";
